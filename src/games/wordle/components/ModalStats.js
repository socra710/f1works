        ...
        {values.map((value, index) => (
          <div className="guess-item" key={index}>
            ...
            <div className="guess-graph" aria-hidden="true">
              <div
                className={`graph-bar ${props.gameStats?.todayIdx === index ? 'correct' : ''}`}
                style={{
                  width: `${calculatedPercentages[index] === 0 ? 6 : calculatedPercentages[index]}%`,
                }}
              >
