        ...
        <section className="expense-section info-box">
          ...
          <ul>
            ...
            <li>
              ...
              유지보수율을 적용해 자동 계산. 유류타입이 ‘없음’이면 유류비
              0원(통행료만 반영).
            </li>
            <li>
              법인카드: 관리자 모드에서만 입력 가능, 지급액은 금액 그대로
              반영됩니다.
            </li>
            <li>
              임시 저장/제출없음/제출 버튼은 상태와 권한에 따라 표시됩니다.
              제출없음은 해당 월 자동 승인 처리됩니다.
            </li>
            <li>
              최근 내역 가져오기: 지난달 데이터를 불러와 현재 청구월로 변환하여
              추가할 수 있습니다.
            </li>
            <li>
              관리자 모드: 승인/반려 처리 및 항목별 ‘확인’ 체크가 가능하며, 확인
              완료 후에는 수정이 제한됩니다.
            </li>
          </ul>
        </section>
