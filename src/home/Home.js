  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:image"
          content="https://codefeat.netlify.app/codefeat.png"
        />
          ...
          <li>
            <strong>
              <a href="/works" target="_self">
                F1Works - 회사 자원 공유 앱(비공개)
              </a>
            </strong>
            <br></br>
            회사 내에서 자원을 효율적으로 공유하고 소통하는 데 도움이 되는
            앱입니다.직원들 간의 협업을 강화하고 업무 효율성을 높이는데
            기여합니다.
          </li>
          <li>
            <strong>
              <a href="/games/wordle" target="_self">
                클론게임 - 오늘의 단어를 무엇일까요?(공개)
              </a>
            </strong>
            <br></br>
          ...
          <li>
            <strong>
              <a href="/feed" target="_self">
                SwiftFeed - Works 사용자를 위한 뉴스 피드(공개)
              </a>
            </strong>
            <br></br>
      ...
      <section className="default-section">
        <h2>연락처</h2>
        <p>
          언제든지 연락 주세요! 제 포트폴리오에 대한 질문이나 협업 제안이 있다면
          아래의 이메일 주소로 연락해 주세요
          <br></br>
